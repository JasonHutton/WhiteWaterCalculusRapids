...
class ViewController: GLKViewController {
    ...
    override func viewDidLoad() {
        ...
        Settings.instance.playMusic(soundFile: "gameplay3", loop: -1)
    ...
    public func win(){
        ...
        Settings.instance.playMusic(soundFile: "complete", loop: 0)
    }
    
    public func lose(){
        performSegue(withIdentifier: "loseGame", sender: nil)
        Settings.instance.playMusic(soundFile: "gameover", loop: 0)
    }
    
    public func quit(){
        scoreLabel.text = "Score: \(score)"
        Settings.instance.playMusic(soundFile: "menu", loop: -1)
        tearDownGL()
        tearDownLevel()
