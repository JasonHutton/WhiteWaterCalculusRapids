...
class ViewController: GLKViewController {
    ...
    private func setupGL() {
        ...
        surfaceObj2.addComponent(component: BlockBody(tag: "Floor2"))
        ...
        surfaceObj3.addComponent(component: BlockBody(tag: "Floor3"))
        ...
        surfaceObj4.addComponent(component: BlockBody(tag: "Floor4"))
        ...
        leftWall.addComponent(component: BlockBody(tag: "Floor5"))
        ...
        rightWall.addComponent(component: BlockBody(tag: "Floor6"))
        ...
        topWall.addComponent(component: BlockBody(tag: "Floor7"))
        ...
        bottomWall.addComponent(component: BlockBody(tag: "Floor8"))
        ...
        deathWall.addComponent(component: BlockBody(tag: "Floor9"))
